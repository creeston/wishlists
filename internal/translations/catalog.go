...
var messageKeyToIndex = map[string]int{
	"Add a wish": 8,
	"Belarusian": 6,
	"Built with %sPico%s • %sSource code%s": 21,
	...
	"This website uses cookies to save your session, allowing you to edit your wishlist and mark items to reserve in this browser.": 20,
...
var be_BYIndex = []uint32{ // 23 elements
	...
	0x00000462, 0x00000582, 0x000005dc,
} // Size: 116 bytes

const be_BYData string = "" + // Size: 1500 bytes
	...
	"ласка, выдаліце некаторыя элементы.\x02Гэты сайт выкарыстоўвае кукі для" +
	" захавання вашай сесіі, каб вы маглі рэдагаваць свой спіс пажаданняў і а" +
	"дзначаць зарэзерваваныя падарункі ў гэтым браўзэры.\x02Створана з дапам" +
	"огай %[1]sPico%[2]s • %[3]sЗыходны код%[4]s"

var en_GBIndex = []uint32{ // 23 elements
	...
	0x00000210, 0x0000028e, 0x000002c2,
} // Size: 116 bytes

const en_GBData string = "" + // Size: 706 bytes
	...
	" some items.\x02This website uses cookies to save your session, allowing" +
	" you to edit your wishlist and mark items to reserve in this browser." +
	"\x02Built with %[1]sPico%[2]s • %[3]sSource code%[4]s"

var pl_PLIndex = []uint32{ // 23 elements
	...
	0x00000263, 0x00000304, 0x0000033d,
} // Size: 116 bytes

const pl_PLData string = "" + // Size: 829 bytes
	...
	"u przedmiotów na liście. Proszę usunąć kilka przedmiotów.\x02Ta strona u" +
	"żywa plików cookie do zapisywania sesji, aby można było edytować swoją " +
	"listę życzeń i zaznaczać zarezerwowane prezenty w tej przeglądarce.\x02Z" +
	"budowane z %[1]sPico%[2]s • %[3]sKod źródłowy%[4]s"

var ru_RUIndex = []uint32{ // 23 elements
	...
	0x00000472, 0x00000596, 0x000005ec,
} // Size: 116 bytes

const ru_RUData string = "" + // Size: 1516 bytes
	...
	"ске. Пожалуйста, удалите некоторые элементы.\x02Этот сайт использует ку" +
	"ки для сохранения вашей сессии, чтобы вы могли редактировать свой списо" +
	"к желаний и отмечать зарезервированные подарки в этом браузере.\x02Сдел" +
	"ано с помощью %[1]sPico%[2]s • %[3]sИсходный код%[4]s"

	// Total table size 5015 bytes (4KiB); checksum: 4B138D1
